...
if [[ $OS == "debian" ]]; then
    ...
    curl -fsSL https://deb.nodesource.com/gpgkey/nodesource-repo.gpg.key | gpg --dearmor --yes -o /usr/share/keyrings/nodesource-archive-keyring.gpg 2>&1 | tee -a "$LOG_FILE"
